...
from cosgcn.utils import set_seed
from cosgcn.model import COSGCNTrainer
        ...
        for ratio in perturb_ratios:
            ...
            try:
                ...
                if ratio == 0.0:
                    ...
                    print(f"  加载扰动邻接矩阵完成")
                trainer = COSGCNTrainer(**RRAMGCN_PARAMS, device=str(model_device))
